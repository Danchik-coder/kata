...
ball = Ball(x= 200,y = 540,filename="ball.jpg",speed = q,v = 50,n = 50)
racketka_left = Racketka(x = 10,y=540,filename="racketka1.png",speed = a,v = 50,n = 160)
racketka_right = Racketka1(x = 1340,y = 540,filename="racketka.png",speed = a,v = 50,n = 160)
...
fon=image.load("hr.png")
fon = transform.scale(fon, (1366,688))

font.init()
shirift = font.SysFont("Impact",155)
